...
export function HeroSection() {
  return (
    <section
      className="relative w-full min-h-screen bg-cover bg-center bg-no-repeat flex items-end"
     
    >
      <Image src="/home-herobg.jpg" alt="AulonaFlows Hero Background" layout="fill" objectFit="cover" className="mix-blend-luminosity" />
      ...
      <div className="relative z-10 p-6 pb-12 md:pb-24 md:p-24">
        ...
        {/* Headline */}
        <h1 className="headline-text leading-normal md:leading-normal text-3xl md:text-5xl font-semibold mb-3 text-white">The healing you 
        ...
        <Button className="border border-[#FFBE5D] rounded-3xl px-4 md:px-8 py-3 md:py-6 text-xs md:text-base font-medium transition-all duration-300 flex items-center gap-2"
          style={{
